...
### 🔴 #31 — `apply_spec_fallback_v3` (пост-corrections) не перенесён в v6: 535 996 строк вне правил специалиста

**Суть.** В v5 `corrections.apply_spec_fallback_v3()` вызывается ОТДЕЛЬНО из `pipeline.py:1857/2030`
