...
<!-- v6-scope-banner -->
> 🧭 **Область в v6_ch (2026-08-15).** Исторический снимок сверки от 2026-06-18 на данных v5.
> Не перепроверялся на v6. Актуальная сверка контуров — `RAW_DIFF_FINDINGS.md`.
